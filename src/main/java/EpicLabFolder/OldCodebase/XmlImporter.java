...
public class XmlImporter extends ImporterBasic {
    @Override
                ...
                try (var fileInputStream = new FileInputStream(file)) {
                    ...
                    for (int i = 0; i < nodeList.getLength(); i++) {
                        if (nodeList.item(i).getNodeType() == org.w3c.dom.Node.ELEMENT_NODE) {
                            ...
                            ReactorOld reactorOld = parseReactor(element);
                            reactorMap.addReactor(element.getNodeName(), reactorOld);
                        }
                    }
                }
            } catch (Exception e) {
    ...
    private ReactorOld parseReactor(Element element) {
        ...
        return new ReactorOld(type, reactorClass, burnup, electricalCapacity, enrichment, firstLoad, kpd, lifeTime, thermalCapacity, "XML");
    }
